...
const PagesPage: React.FC = () => {
  ...
  if (!loaded) {
    return <div className="text-white/30 text-xl font-bold text-center py-20">جارِ تحميل الصفحات…</div>;
  }
    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="grid gap-4">
        ...
        {customPages.length === 0 && (
          <div className="text-white/10 text-center py-10 text-lg font-bold">لا توجد صفحات مخصصة بعد</div>
        )}
        {customPages.map(pg => (
